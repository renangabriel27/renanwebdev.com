  ...
  return (
    <div className="bg-white dark:bg-gray-900">
      <Head>
        ...
        <meta property="og:url" content={`https://renanwebdev.com${router.asPath}`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Renan Gabriel" />
      ...
      <nav className="flex justify-end items-center max-w-3xl p-8 my-0 md:my-8 mx-auto bg-white dark:bg-gray-900 bg-opacity-60">
        ...
        <button
          ...
          type="button"
          className="bg-gray-200 dark:bg-gray-800 rounded p-3 ml-3 h-10 w-10"
